...
class SideContentComponent extends React.Component {
  ...
  refreshInfo() {
    AccountProfileService.retrieveDetails(this.props.username).then(
      (response) => {
        this.setState({
    ...
    return (
      <div className="col-lg-4 row-md">
        <div className="ui-block">
          <div
            className="ui-title"
            style={{ display: "flex", minHeight: 61 + "px" }}
          >
            <h5
              style={{
                marginBottom: 0,
            ...
            this.props.username ? (
              <OverlayTrigger
                placement={"bottom"}
                overlay={
                  <Tooltip id={"tooltip-bottom"}>Edit your information</Tooltip>
                }
              >
                <Edit
                  width={20}
          ...
          <div className="ui-content">
            <div className="personal-info">
              ...
              <li>
                ...
                <span className="text">{this.state.aboutme}</span>
              </li>
