...
import com.sept.rest.webservices.restfulwebservices.dao.DBFileService;
...
public class FileController {
    ...
    public UploadFileResponse uploadAvatar( @PathVariable String username, @RequestBody MultipartFile file) {
        ...
        DBFile toDelete =  dbFileService.retrieveByFileUrl(fileDownloadUri);

        if(toDelete != null){
            dbFileService.deleteById(toDelete.getId());
        }

        dbFile.setFileURL(fileDownloadUri);

        dbFileService.submitFileToDB(dbFile);
