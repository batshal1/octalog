...
export class Register extends React.Component {
  ...
  checkDuplicateUser(username) {
    if (username != null) {
      AccountProfileService.checkDuplicateUsername(username).then(
        (response) => {
  ...
  validate(values) {
    ...
    if (!passwordCheck.test(values.password)) {
      errors.password =
        "Minumum 8 characters long, 1 lower and upper case, 1 number";
    }
              ...
              <Form>
                ...
                <fieldset className="form-group">
                  ...
                  <OverlayTrigger
                    ...
                    overlay={
                      <Tooltip id={"tooltip-bottom"}>
                        More than 8 chars, 1 lower and upper case, 1 number
                      </Tooltip>
                    }
                  >
                ...
                <div className={"footerBtn"}>
                  <button
                    type="submit"
                    className="btn text-center btn-info center"
                    name={"register"}
                  >
                    Register
                  </button>
