      ...
      <div className="App">
        <div className="LoginComponent">
          <div className="Description">
            ...
            <p>
              Octalog an electronic logbook for all the divers around the globe.{" "}
              <b>
                Join today so that you can be a part of the amazing adventure.
              </b>
              <br />
              <br />
              <span>
                Made possible by student of&nbsp;
                <a
